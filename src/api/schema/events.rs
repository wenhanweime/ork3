...
pub enum Subscription {
    ...
    LayoutUpdated {},
    #[serde(rename = "project.snapshot.updated")]
...
impl EventKind {
    pub fn dot_name(self) -> &'static str {
        match self {
            ...
            EventKind::ProjectSnapshotUpdated => "project.snapshot.updated",
        }
    }
}
...
pub const KNOWN_EVENT_KINDS: &[EventKind] = &[
    ...
    EventKind::ProjectSnapshotUpdated,
];
...
pub enum EventData {
    ...
    ProjectSnapshotUpdated {
        revision: u64,
        scan_status: Vec<super::projects::AdapterScanStatus>,
    },
}
